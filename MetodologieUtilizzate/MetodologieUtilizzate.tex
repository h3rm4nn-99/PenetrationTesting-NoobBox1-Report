...
\begin{figure}[h!]
    ...
    \caption{\texttt{dirb} ha rilevato wordpress}
\end{figure}
...
Basandosi sull'output di \texttt{dirb} diventa subito evidente che il \textit{focus} dell'indagine debba cadere sull'analisi dell'installazione corrente di \textbf{wordpress}. 

Per completezza, verranno comunque presi in considerazione gli altri due tool precedentemente menzionati.
