...
Di seguito è presente l'output di questa scansione. Il report completo è allegato a questo docuemnto nel file \texttt{dirb-documents-output.txt}.
...
Consultando i risultati del tool, all'interno di tale cartella sembra sia \textbf{sia effettivamente presente un'installazione di wordpress}.
